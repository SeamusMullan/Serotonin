...
i686-elf-gcc -Ttext=0x400100 -nostdlib crt0.o receiver.o syscall.o -Wl,--start-group -lc -lm -Wl,--end-group -o receiver.elf
i686-elf-gcc -Ttext=0x400100 -nostdlib crt0.o sender.o syscall.o -Wl,--start-group -lc -lm -Wl,--end-group -o sender.elf
