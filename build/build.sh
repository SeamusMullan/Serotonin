...
i686-elf-gcc -c audio/pcspeaker/pcspeaker.c -o audio/pcspeaker/pcspeaker.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra -msse -mfpmath=sse
i686-elf-as -c syscall/isr_syscall.s -o syscall/isr_syscall.o
i686-elf-gcc -c syscall/syscall.c -o syscall/syscall.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra -msse -mfpmath=sse
